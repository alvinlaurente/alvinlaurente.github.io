      ...
      [
        {
          ...
          'px-5 py-3 text-sm': (size.length === 0 && !outlined) || (size === 'normal' && !outlined),
          'px-5 py-2 text-sm': size === 'sm' && !outlined,
          'px-3 py-2 text-xs': size === 'xs' && !outlined,
          'px-5 py-2.5 text-sm': (size.length === 0 && outlined) || (size === 'normal' && outlined),
  ...
  computed: {
    ...
    buttonOutlineColor () {
      return {
        ...
        'border-white-transparent text-white-transparent bg-white-transparent': this.outlineColor === 'white-transparent'
      }
    },
    buttonFullWidth () {
      return {
